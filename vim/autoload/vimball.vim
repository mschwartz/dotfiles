...
let g:loaded_vimball = "v30j	Jun 04, 2009"
if v:version < 702
 echohl WarningMsg
...
"  call Dfunc("vimball#SaveSettings()")
  ...
  setlocal ff=unix
"  call Dret("vimball#SaveSettings")
endfun

" ---------------------------------------------------------------------
" vimball#RestoreSettings: {{{2
fun! vimball#RestoreSettings()
"  call Dfunc("vimball#RestoreSettings()")
  let @a      = s:regakeep
  if exists("&acd")
   let &acd   = s:acdkeep
  endif
...
"  call Dret("vimball#RestoreSettings")
endfun
