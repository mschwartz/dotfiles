...
plugins=(z vi-mode git sudo colorize bower brew colored-man node npm jsontools osx redis-cli rvm sublime terminalapp themes tmux docker docker-compose zsh-syntax-highlighting vscode systemd fzf fasd command-not-found)
