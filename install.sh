...
if [[ $platform == 'linux' ]]; then
    sudo apt-get install -y build-essential speedtest-cli zsh vim cmake vim-youcompleteme python-dev libboost-all-dev tmux curl ruby-dev ctags screenfetch net-tools neofetch
    echo ...nodejs
